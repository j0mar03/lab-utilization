        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 font-bold text-gray-800 dark:text-gray-200">
                        <span class="text-xl">🔬</span>
                        <span class="text-sm font-semibold tracking-wide">PUP-ITECH Lab</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-8 sm:flex">
                    ...
                    {{-- Transactions (Lab Head & Student Assistant) --}}
                    ...
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div class="flex items-center gap-2">
                                ...
                                @if (Auth::user()->isLabHead())
                                    <span class="text-xs bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 rounded px-1.5 py-0.5 font-semibold">Admin</span>
                                @elseif (Auth::user()->isStudentAssistant())
                                    <span class="text-xs bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 rounded px-1.5 py-0.5 font-semibold">Assistant</span>
                                @else
                                    <span class="text-xs bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300 rounded px-1.5 py-0.5 font-semibold">Faculty</span>
                                @endif
                            </div>
