            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-6 border border-gray-100 dark:border-gray-700">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        Register a faculty instructor so they appear in lab transaction logs and borrow authorization records.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.faculties.store') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Must be unique. Used for laboratory audit records and automated notifications.
                        </p>
                        @error('email')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    Only active faculty members appear in borrowing forms and transaction dropdowns.
                                </p>
                            </div>
                        </label>
                        @error('is_active')
